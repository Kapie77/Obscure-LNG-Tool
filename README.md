<div align="center">
  ...
  <p>A cross-plataform CLI tool to extract (converting them to editable formats such as .txt and .csv) and rebuild `.lng` files from <b>Obscure (2004)</b>, **Obscure II: The Aftermath (2007)** and **Final Exam (2013)**.</p>
</div>
---
